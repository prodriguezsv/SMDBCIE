...
public class NormTest {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		norm = new Norm(new Descriptor<Object>("Cuerpo", "Longitud", 0.3));
	}
	...
	public final void testAddSuccessor() {
		...
		assertTrue(norm.addSuccessor(new SheetCase(new Descriptor<Object>("Cuerpo", "Longitud", 0.3))));
		...
		assertFalse(norm.addSuccessor(new SheetCase(new Descriptor<Object>("Pie", "Disposición", "Sobresale al manto"))));
	...
	public final void testGetNearestPredecessorNorm() {
		...
		index = new Index("Longitud");
		norm2 = new Norm(new Descriptor<Object>("Branquias", "Número de hojas branquiales", 6));
	...
	public final void testSuccessorCases() {
		...
		norm.addSuccessor(new SheetCase(new Descriptor<Object>("Cuerpo", "Longitud", 0.3)));
	...
	public final void testGetNearestSuccessorNorm() {
		...
		assertNull(norm.getNearestSuccessorNorm(new Descriptor<Object>("Cuerpo", "Longitud", 0.3)));
		
		System.out.println("Verificar que se obtiene la norma sucesor más cercana no null");
		index = new Index("Longitud");
		norm2 = new Norm(new Descriptor<Object>("Cuerpo", "Longitud", 0.3));
		index.addSuccessor(norm2);
		norm.addSuccessor(index);
		assertNotNull(norm.getNearestSuccessorNorm(new Descriptor<Object>("Cuerpo", "Longitud", 0.3)));
		
		System.out.println("Verificar que no se obtiene la norma sucesor más cercana si no existe");
		assertNull(norm.getNearestSuccessorNorm(new Descriptor<Object>("Branquias", "Número de hojas branquiales", 6)));
		
		System.out.println("Verificar que se obtiene la norma sucesor más cercana que en efecto es");
		assertSame(norm2, norm.getNearestSuccessorNorm(new Descriptor<Object>("Cuerpo", "Longitud", 0.3)));
	}
	...
	public final void testGetSuccessorIndexDescriptor() {
		...
		System.out.println("Verificar que se obtiene un índice sucesor null");
		assertNull(norm.getSuccessorIndex(new Descriptor<Object>("Cuerpo", "Longitud", 0.3)));
		...
		index.addSuccessor(norm2);
		norm.addSuccessor(index);
		assertNotNull(norm.getSuccessorIndex(new Descriptor<Object>("Cuerpo", "Longitud", 0.3)));
		
		System.out.println("Verificar que se obtiene el índice sucesor que en efecto es");
		assertSame(index, norm.getSuccessorIndex(new Descriptor<Object>("Cuerpo", "Longitud", 0.3)));
	}
}
