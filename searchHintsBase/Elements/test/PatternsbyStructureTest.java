...
public class PatternsbyStructureTest {
	...
	public void testHasAPatternSimilarTo() {
		...
		d2.addToConcreteDescription(new SSCharacterDescriptor("Cuerpo", "Conformación", "Tiene cerata"));
		...
		d3.addToConcreteDescription(new SSCharacterDescriptor("Cuerpo", "Conformación", "Tiene cerata"));
